...
<iframe
  src="https://codesandbox.io/embed/github/miguelquispe/demo-tutorial-tailwind-principiantes/tree/master/?autoresize=1&fontsize=14&hidenavigation=1&theme=dark"
  style={{
    width: '100%',
    height: 500,
    border: 0,
