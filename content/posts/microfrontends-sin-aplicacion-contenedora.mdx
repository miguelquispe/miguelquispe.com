  ...
  items={[
    {
      ...
      href: '/microfrontends-sin-aplicacion-contenedora',
      current: true,
    },
    {
      label: 'Parte 2: Mi enfoque para un escenario ideal (próximamente)',
      href: '/microfrontends-escenario-ideal',
      disabled: true,
    },
    {
      label:
        'Parte 3: Lineamientos y configuración entre equipos (próximamente)',
      href: '/microfrontends-configuracion-convenciones',
      disabled: true,
    },
  ]}
/>
...
👉 Continúa con la siguiente parte: [MicroFrontend: Mi enfoque para un escenario ideal ](#)
