...
**Nota**: longitudeDelta y latitudeDelta son los valores que determinan el zoom del mapa. [^1]
...
[^1]: [React native MapView: what is latitudeDelta longitudeDelta](https://stackoverflow.com/questions/50882700/react-native-mapview-what-is-latitudedelta-longitudedelta)
